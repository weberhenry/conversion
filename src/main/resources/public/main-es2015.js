...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-posts></app-posts>");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_services_metrics_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/metrics.service */ "./src/app/services/metrics.service.ts");
...
let PostsComponent = class PostsComponent {
    ...
    parseMetric_() {
        this.metricService.convertMetric(this.userForm.form.controls.metric.value, this.userForm.form.controls.fromMetric.value, this.userForm.form.controls.toMetric.value, this.userForm.form.controls.value.value)
            .subscribe(data => {
            console.log(data);
            if (data.length != 0) {
                this.result = data;
            ...
            this.userForm.form.controls.value.setValue("0");
            this.userForm.form.controls.result.setValue("0");
        });
    }
    parseMetric() {
        this.metricService.convertMetric(this.metric, this.fromMetric, this.toMetric, this.value)
            .subscribe(data => {
            console.log(data);
            if (data.length != 0) {
                this.result = data;
    ...
    parseMetricByMetricCatogoryExclFromMetric_() {
        this.metricService.getMetricByMetricCatogoryExclFromMetric(this.userForm.form.controls.metric.value, this.userForm.form.controls.fromMetric.value)
            .subscribe(data => {
            console.log(data);
            if (data.length != 0) {
                this.toMetrics = data;
                this.toMetric = this.toMetrics[0];
                this.value = "0";
                this.result = "0";
                this.parseMetric_();
            }
    ...
    parseMetricByMetricCatogoryExclFromMetric() {
        this.metricService.getMetricByMetricCatogoryExclFromMetric(this.metric, this.fromMetric)
            .subscribe(data => {
            console.log(data);
            if (data.length != 0) {
                this.toMetrics = data;
    ...
    parseMetricByMetricCatogory_() {
        this.metricService.getMetricByMetricCatogory(this.userForm.form.controls.metric.value)
            .subscribe(data => {
            console.log(data);
            if (data.length != 0) {
                this.fromMetrics = data;
                this.fromMetric = this.fromMetrics[0];
                this.parseMetricByMetricCatogoryExclFromMetric_();
            }
        }, error => console.log(error));
    }
    parseMetricByMetricCatogory() {
        this.metricService.getMetricByMetricCatogory(this.metric)
            .subscribe(data => {
            console.log(data);
            if (data.length != 0) {
                this.fromMetrics = data;
                this.fromMetric = this.fromMetrics[0];
                this.parseMetricByMetricCatogoryExclFromMetric();
            }
        }, error => console.log(error));
    }
    parseMetricCategories() {
        this.metricService.getMetricCatogories()
            .subscribe(data => {
            console.log(data);
            this.metrics = data;
            this.metric = this.metrics[0];
            this.parseMetricByMetricCatogory();
        }, error => console.log(error));
    }
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('userForm', { static: true })
...
let MetricsService = class MetricsService {
    ...
    getMetricByMetricCatogory(metricCategory) {
        return this.http.get(`${this.baseUrl}/${metricCategory}`);
    }
    getMetricByMetricCatogoryExclFromMetric(metricCategory, fromMetric) {
        return this.http.get(`${this.baseUrl}/${metricCategory}/${fromMetric}`);
    }
    convertMetric(metricCategory, fromMetric, toMetric, value) {
        return this.http.get(`${this.baseUrl}/${metricCategory}/${fromMetric}/${toMetric}/${value}`);
    }
};
...
module.exports = __webpack_require__(/*! C:\Workspace\MetricConversionUI\src\main.ts */"./src/main.ts");
